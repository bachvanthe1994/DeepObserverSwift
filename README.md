...
mys: key: mys, indexs: [:], object: 
-----------------7
mys: key: mys.users.users.avatar, indexs: ["mys": 0, "mys.users": 2, "mys.users.users": 3], object: 
mys: key: mys, indexs: [:], object: 
mys: key: mys.users, indexs: ["mys": 0], object: 
mys: key: mys, indexs: [:], object: 
mys: key: mys.users.users, indexs: ["mys": 0, "mys.users": 2], object: 
...
mys: key: mys, indexs: [:], object: 
-----------------10
mys: key: my.user, indexs: [:], object: 
mys: key: my.users, indexs: [:], object: 
mys: key: my.width, indexs: [:], object: 
mys: key: my.name, indexs: [:], object: 
mys: key: my.age, indexs: [:], object: 
mys: key: my.height, indexs: [:], object: 
mys: key: my.weight, indexs: [:], object: 
mys: key: my, indexs: [:], object: 
-----------------11
mys: key: my.name, indexs: [:], object: 
-----------------12
mys: key: my.name, indexs: [:], object: 
-----------------13
mys: key: my.user.users, indexs: [:], object: 
mys: key: my.user.email, indexs: [:], object: 
mys: key: my.user.phoneNumber, indexs: [:], object: 
mys: key: my.user.avatar, indexs: [:], object: 
mys: key: my.user, indexs: [:], object: 
-----------------14
mys: key: my.users, indexs: [:], object: 
-----------------15
mys: key: my.users.users, indexs: ["my.users": 2], object: 
mys: key: my.users, indexs: [:], object: 
-----------------16
mys: key: my.users.users.avatar, indexs: ["my.users": 2, "my.users.users": 3], object: 
mys: key: my.users, indexs: [:], object: 
mys: key: my.users.users, indexs: ["my.users": 2], object: 
mys: key: my.users, indexs: [:], object: 
-----------------17
